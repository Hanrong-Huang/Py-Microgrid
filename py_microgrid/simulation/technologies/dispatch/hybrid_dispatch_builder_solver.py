...
from py_microgrid.simulation.technologies.dispatch import (
    HybridDispatch,
...
class HybridDispatchBuilderSolver:
    ...
    def _create_dispatch_optimization_model(self):
        ...
        # Blocks (technologies)         #
        #################################
        module = getattr(__import__("py_microgrid").simulation.technologies, "dispatch")
