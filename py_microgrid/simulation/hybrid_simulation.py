from typing import Dict, Iterable, Optional, Sequence, Union, Any
import csv
...
from py_microgrid.tools.analysis import create_cost_calculator
from py_microgrid.simulation.technologies.sites.site_info import SiteInfo
from py_microgrid.simulation.technologies.pv.pv_plant import PVPlant, PVConfig
from py_microgrid.simulation.technologies.pv.detailed_pv_plant import DetailedPVPlant, DetailedPVConfig
from py_microgrid.simulation.technologies.wind.wind_plant import WindPlant, WindConfig
from py_microgrid.simulation.technologies.csp.tower_plant import TowerConfig, TowerPlant
...
class HybridSimulation(BaseClass):
    ...
    Args:
        ...
        dispatch_options: (optional) dictionary of dispatch options. For details see
            :class:`py_microgrid.simulation.technologies.dispatch.hybrid_dispatch_options.HybridDispatchOptions`
