...
class CostCalculator():
    ...
    def calculate_installed_costs(self, wind_size, pv_size, storage_size_mw=0., storage_size_mwh=0.):
        ...
        storage_installed_cost = self.storage_installed_cost_mwh * storage_size_mwh + self.storage_installed_cost_mw * storage_size_mw  # To match with HOMER battery installed cost
        """ 
        # Orginal HOPP battery installed cost calculation
...
def create_cost_calculator(interconnection_mw: float,
                           ...
                           wind_installed_cost_mw: float = 2500000, # modified to match with HOMER, $2500 per kW
                           solar_installed_cost_mw: float = 2000000, # modified to match with HOMER, $2000 per kW
                           storage_installed_cost_mwh: float = 700000, # modified to match with HOMER, $700 per kWh
                           storage_installed_cost_mw: float = 0, # modified to match with HOMER, HOMER does not include battery power in the battery installed cost
                           # storage_installed_cost_mw: float = 291000, # HOPP default value
                           # storage_installed_cost_mwh: float = 335000, # HOPP default value
