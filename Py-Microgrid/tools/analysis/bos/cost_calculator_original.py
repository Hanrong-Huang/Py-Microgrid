...
def create_cost_calculator(interconnection_mw: float,
                           ...
                           wind_installed_cost_mw: float = 1454000, # can be modify to adjust the install cost
                           solar_installed_cost_mw: float = 960000, # can be modify to adjust the install cost
                           storage_installed_cost_mw: float = 291000, # can be modify to adjust the install cost
                           storage_installed_cost_mwh: float = 335000, # can be modify to adjust the install cost
