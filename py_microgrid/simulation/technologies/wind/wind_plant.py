...
from py_microgrid.type_dec import resource_file_converter
from py_microgrid.utilities import load_yaml
from py_microgrid.utilities.validators import gt_zero, contains
from py_microgrid.simulation.technologies.wind.floris import Floris
...
from py_microgrid.simulation.technologies.layout.wind_layout import WindLayout, WindBoundaryGridParameters
from py_microgrid.simulation.technologies.financial import CustomFinancialModel, FinancialModelType
...
class WindConfig(BaseClass):
    ...
    rating_range_kw: Tuple[int, int] = field(default=(100, 3000))
