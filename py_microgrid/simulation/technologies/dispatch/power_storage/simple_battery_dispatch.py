...
from py_microgrid.simulation.technologies.financial import FinancialModelType
...
class SimpleBatteryDispatch(PowerStorageDispatch):
    ...
    def __init__(
        ...
        Args:
            ...
            system_model (BatteryModel.Battery): The battery stateful model.
    ...
    def _set_control_mode(self):
        """Sets control mode."""
        if isinstance(self._system_model, BatteryModel.Battery):
